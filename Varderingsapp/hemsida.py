...
with col1: 
    eps = st.number_input("Nuvarande EPS: (exempelvis 5.0)", min_value=1.0, value=1.0, max_value=500, step = 0.1)
with col2: 
...
stockprice = st.number_input("Vad är aktiekursen idag?", min_value=1.0, value=1.0, max_value=5000, step = 0.1)
